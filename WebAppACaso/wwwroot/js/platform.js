...
function initGame(level) {
  ...
  if (level === 1) {
    ...
    player = new Marmotta(100, worldHeight - 4860);
    ...
    spines = [
      ...
      new Spina(3300, 3796, 50, 25, "up"),
      new Spina(3332, 3796, 50, 25, "up"),
      new Spina(3379, 3820, 30, 54, "right"),
      new Spina(3379, 3870, 30, 54, "right"),
      new Spina(3379, 3920, 30, 54, "right"),
      new Spina(3379, 3970, 30, 54, "right"),
      new Spina(3379, 4020, 30, 54, "right"),
      new Spina(3379, 4070, 30, 54, "right"),
      new Spina(3271, 3820, 30, 54, "left"),
      new Spina(3271, 3870, 30, 54, "left"),
      new Spina(3271, 3920, 30, 54, "left"),
      new Spina(3271, 3970, 30, 54, "left"),
      new Spina(3271, 4020, 30, 54, "left"),
      new Spina(3271, 4070, 30, 54, "left"),
      new Spina(3300, 4124, 50, 25, "down"),
      new Spina(3332, 4124, 50, 25, "down"),

      new Spina(2910, 4221, 50, 25, "up"),
      new Spina(2942, 4221, 50, 25, "up"),
      new Spina(2989, 4245, 30, 54, "right"),
      new Spina(2989, 4295, 30, 54, "right"),
      new Spina(2989, 4345, 30, 54, "right"),
      new Spina(2989, 4395, 30, 54, "right"),
      new Spina(2989, 4445, 30, 54, "right"),
      new Spina(2989, 4495, 30, 54, "right"),
      new Spina(2881, 4245, 30, 54, "left"),
      new Spina(2881, 4295, 30, 54, "left"),
      new Spina(2881, 4345, 30, 54, "left"),
      new Spina(2881, 4395, 30, 54, "left"),
      new Spina(2881, 4445, 30, 54, "left"),
      new Spina(2881, 4495, 30, 54, "left"),
      new Spina(2910, 4549, 50, 25, "down"),
      new Spina(2942, 4549, 50, 25, "down"),

      new Spina(2440, 3571, 50, 25, "up"),
      new Spina(2472, 3571, 50, 25, "up"),
      new Spina(2519, 3590, 30, 54, "right"),
      new Spina(2519, 3640, 30, 54, "right"),
      new Spina(2519, 3690, 30, 54, "right"),
      new Spina(2519, 3740, 30, 54, "right"),
      new Spina(2519, 3790, 30, 54, "right"),
      new Spina(2519, 3840, 30, 54, "right"),
      new Spina(2411, 3590, 30, 54, "left"),
      new Spina(2411, 3640, 30, 54, "left"),
      new Spina(2411, 3690, 30, 54, "left"),
      new Spina(2411, 3740, 30, 54, "left"),
      new Spina(2411, 3790, 30, 54, "left"),
      new Spina(2411, 3840, 30, 54, "left"),
      new Spina(2440, 3894, 50, 25, "down"),
      new Spina(2472, 3894, 50, 25, "down"),

      new Spina(1865, 4076, 50, 25, "up"),
      new Spina(1897, 4076, 50, 25, "up"),
      new Spina(1944, 4095, 30, 54, "right"),
      new Spina(1944, 4145, 30, 54, "right"),
      new Spina(1944, 4195, 30, 54, "right"),
      new Spina(1944, 4245, 30, 54, "right"),
      new Spina(1944, 4295, 30, 54, "right"),
      new Spina(1944, 4345, 30, 54, "right"),
      new Spina(1836, 4095, 30, 54, "left"),
      new Spina(1836, 4145, 30, 54, "left"),
      new Spina(1836, 4195, 30, 54, "left"),
      new Spina(1836, 4245, 30, 54, "left"),
      new Spina(1836, 4295, 30, 54, "left"),
      new Spina(1836, 4345, 30, 54, "left"),
      new Spina(1865, 4399, 50, 25, "down"),
      new Spina(1897, 4399, 50, 25, "down"),

      new Spina(710, 3941, 50, 25, "up"),
      new Spina(742, 3941, 50, 25, "up"),
      new Spina(789, 3960, 30, 54, "right"),
      new Spina(789, 4010, 30, 54, "right"),
      new Spina(789, 4060, 30, 54, "right"),
      new Spina(789, 4110, 30, 54, "right"),
      new Spina(789, 4160, 30, 54, "right"),
      new Spina(789, 4210, 30, 54, "right"),
      new Spina(681, 3960, 30, 54, "left"),
      new Spina(681, 4010, 30, 54, "left"),
      new Spina(681, 4060, 30, 54, "left"),
      new Spina(681, 4110, 30, 54, "left"),
      new Spina(681, 4160, 30, 54, "left"),
      new Spina(681, 4210, 30, 54, "left"),
      new Spina(710, 4264, 50, 25, "down"),
      new Spina(742, 4264, 50, 25, "down"),

      new Spina(2264, 4505, 30, 54, "right"),
      new Spina(2264, 4555, 30, 54, "right"),
      new Spina(2264, 4605, 30, 54, "right"),
      new Spina(2264, 4655, 30, 54, "right"),
      new Spina(2264, 4705, 30, 54, "right"),
      new Spina(2264, 4755, 30, 54, "right"),
      new Spina(2061, 4505, 30, 54, "left"),
      new Spina(2061, 4555, 30, 54, "left"),
      new Spina(2061, 4605, 30, 54, "left"),
      new Spina(2061, 4655, 30, 54, "left"),
      new Spina(2061, 4705, 30, 54, "left"),
      new Spina(2061, 4755, 30, 54, "left"),
      new Spina(2090, 4476, 54, 30, "up"),
      new Spina(2130, 4476, 54, 30, "up"),
      new Spina(2170, 4476, 54, 30, "up"),
      new Spina(2210, 4476, 54, 30, "up"),

      new Spina(1394, 4600, 30, 54, "right"),
      new Spina(1394, 4650, 30, 54, "right"),
      new Spina(1394, 4700, 30, 54, "right"),
      new Spina(1394, 4750, 30, 54, "right"),
      new Spina(1096, 4600, 30, 54, "left"),
      new Spina(1096, 4650, 30, 54, "left"),
      new Spina(1096, 4700, 30, 54, "left"),
      new Spina(1096, 4750, 30, 54, "left"),
      new Spina(1125, 4571, 49, 30, "up"),
      new Spina(1170, 4571, 49, 30, "up"),
      new Spina(1215, 4571, 49, 30, "up"),
      new Spina(1260, 4571, 49, 30, "up"),
      new Spina(1305, 4571, 49, 30, "up"),
      new Spina(1350, 4571, 49, 30, "up"),

      new Spina(1834, 3380, 30, 54, "right"),
      new Spina(1834, 3430, 30, 54, "right"),
      new Spina(1834, 3480, 30, 54, "right"),
      new Spina(1834, 3530, 30, 54, "right"),
      new Spina(1834, 3580, 30, 54, "right"),
      new Spina(1834, 3630, 30, 54, "right"),
      new Spina(1631, 3380, 30, 54, "left"),
      new Spina(1631, 3430, 30, 54, "left"),
      new Spina(1631, 3480, 30, 54, "left"),
      new Spina(1631, 3530, 30, 54, "left"),
      new Spina(1631, 3580, 30, 54, "left"),
      new Spina(1631, 3630, 30, 54, "left"),
      new Spina(1660, 3689, 54, 30, "down"),
      new Spina(1700, 3689, 54, 30, "down"),
      new Spina(1740, 3689, 54, 30, "down"),
      new Spina(1780, 3689, 54, 30, "down"),

      new Spina(1398, 3380, 30, 54, "right"),
      new Spina(1398, 3430, 30, 54, "right"),
      new Spina(1398, 3480, 30, 54, "right"),
      new Spina(1398, 3530, 30, 54, "right"),
      new Spina(1398, 3580, 30, 54, "right"),
      new Spina(1398, 3630, 30, 54, "right"),
      new Spina(1398, 3680, 30, 54, "right"),
      new Spina(1398, 3730, 30, 54, "right"),
      new Spina(1398, 3780, 30, 54, "right"),
      new Spina(1398, 3830, 30, 54, "right"),
      new Spina(1398, 3880, 30, 54, "right"),
      new Spina(1398, 3930, 30, 54, "right"),
      new Spina(1398, 3980, 30, 54, "right"),
      new Spina(1398, 4030, 30, 54, "right"),
      new Spina(1398, 4080, 30, 54, "right"),
      new Spina(1398, 4130, 30, 54, "right"),
      new Spina(1101, 3380, 30, 54, "left"),
      new Spina(1101, 3430, 30, 54, "left"),
      new Spina(1101, 3480, 30, 54, "left"),
      new Spina(1101, 3530, 30, 54, "left"),
      new Spina(1101, 3580, 30, 54, "left"),
      new Spina(1101, 3630, 30, 54, "left"),
      new Spina(1101, 3680, 30, 54, "left"),
      new Spina(1101, 3730, 30, 54, "left"),
      new Spina(1101, 3780, 30, 54, "left"),
      new Spina(1101, 3830, 30, 54, "left"),
      new Spina(1101, 3880, 30, 54, "left"),
      new Spina(1101, 3930, 30, 54, "left"),
      new Spina(1101, 3980, 30, 54, "left"),
      new Spina(1101, 4030, 30, 54, "left"),
      new Spina(1101, 4080, 30, 54, "left"),
      new Spina(1101, 4130, 30, 54, "left"),
      new Spina(1130, 4184, 49, 30, "down"),
      new Spina(1170, 4184, 49, 30, "down"),
      new Spina(1215, 4184, 49, 30, "down"),
      new Spina(1260, 4184, 49, 30, "down"),
      new Spina(1305, 4184, 49, 30, "down"),
      new Spina(1350, 4184, 49, 30, "down"),
    ];

    cartelli = [
      new Cartello(1225, worldHeight - 3385, "Sei bloccato hahahaha, COGLIONE. Ricarica"),
      new Cartello(400, worldHeight - 4783, "Con 'S' puoi scendere più velocemente"),
    ];
